    ...
    <footer className="footer">
      ...
      <div className="footer-content">
        ...
        <div className="footer-brand-section">
          <Link to="/" className="footer-logo cursor-target">
            <div className="footer-logo-icon">BM</div>
            <div className="footer-logo-text">
              <h2>{SITE.name}</h2>
              <span>{SITE.house}</span>
            </div>
          </Link>
          <p className="footer-tagline">
            Where curiosity meets code. Deep dives into tech, AI, and everything in between — curated by our community.
          </p>
        </div>
          ...
          <div className="footer-social-list">
            {SOCIALS.map(social => (
              <a
                ...
                className="footer-social-item cursor-target"
              >
